...
secstr_length_data_org <- read.csv('../../Data/secondary_structure_and_length.tsv', sep='\t', stringsAsFactors = F)
...
##########################################################
# load data
not_approved_sep_chains_data <- read.csv('../../Data/min_sep_chains_env_not_approved_new_columns.csv', stringsAsFactors = F)
not_approved_linker_data <- read.csv('../../Data/min_linker_env_not_approved_new_columns.csv', stringsAsFactors = F)
